 ...
 * Type of search
 */
export type SpotifySearchRequestType =
  (typeof SpotifySearchRequestType)[keyof typeof SpotifySearchRequestType];

export const SpotifySearchRequestType = {
  track: "track",
  artist: "artist",
  album: "album",
} as const;
